...
<html lang="en">
    ...
    <div class="row">
      <div class="col-s-12">
          ...
          <ul class="nav nav-tabs nav-justified">
            ...
            <li role="presentation" class="active"><a href="admin_img.php">Bilder</a></li>
  ...
  <div class="container" id="main">
        ...
        <div id="img_include">
          ...
          <?php
            include('includes/admin_images_inc.php'); // default include

            if(isset($_POST['select_img']) && !isset($_POST['edit_img'])){
              include('includes/admin_imgdetail_inc.php'); // if image is selected
            }
            if(isset($_POST['change_img'])){ // if change is selected
              include('includes/admin_imgchange_inc.php');
            }
        ...
        <?php
          if(isset($_POST['select']) || isset($_POST['edit'])){ // display cancel button if user is at least on layer deep
            ...
            if(isset($_POST['reset'])){ // reload window if cancel is clicked
              echo '<script>
                 window.location.href = "admin_img.php";
              </script>';
            }
          }
         ?>
